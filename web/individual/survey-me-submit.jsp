...
<%System.out.println("Entering survey-me-submit.jsp for empId : " + empid);
    ...
    System.out.println("Starting survey-me-submit.jsp for empId : " + strEmpId + " questionID : " + strQuesId);
    try {
        System.out.println("Entering the try block in survey-me-submit.jspfor empId : " + strEmpId + " questionID : " + strQuesId);
        ...
        if (responseSaved) {
            ...
            System.out.println("Successfully saved me response for empId : " + empid + " question : " + questionId);
        } else {
            jObj.put("message", "Saving failed");
            System.out.println("Could not save me response for empId : " + empid + " question : " + questionId);
        }
        out.print(jObj.toString());
        System.out.println("Exiting survey-me-submit.jsp for empId : " + empid + " questionID : " + questionId);
    } catch (Exception e) {
