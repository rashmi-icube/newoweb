...
! function(t) {
    t.fn.circliful = function(i, e) {
        ...
        return this.each(function() {
            function e(i, e, a) {
                t("<span></span>").appendTo(i).addClass(e).html(c).append(p).css({
                    "line-height": a + "px",
            ...
            function s(e) {
                P.beginPath(), P.arc(M, w, C, -R + A, W * e - R + A, !1), "outline" == f.border ? P.lineWidth = f.width + f.bordersize : "inline" == f.border && (P.lineWidth = f.width - f.bordersize), P.strokeStyle = f.fgcolor, P.stroke(), m > T && (T += S, requestAnimationFrame(function() {
                    s(Math.min(T, m) / 100)
            ...
            if (void 0 != u.data("text") && (c = u.data("text"), void 0 != u.data("icon") && (p = t("<i></i>").addClass("fa fa-" + t(this).data("icon")).css({
                    color: f.iconcolor,
            ...
            } else void 0 != t(this).data("percent") ? (r = t(this).data("percent") / 100, m = t(this).data("percent")) : r = a.percent / 100;
            ...
            var M = (t(y).parent(), x / 2),
                ...
                Q = f.delay;
            void 0 != t(this).data("type") && (j = t(this).data("type"), "half" == j && (k = 2 * Math.PI, F = 3.13, W = Math.PI, R = Math.PI / .996)), void 0 != t(this).data("type") && (j = t(this).data("type"), "angle" == j && (k = 2.25 * Math.PI, F = 2.4, W = 1.53 + Math.PI, R = .73 + Math.PI / .996)), d(), setTimeout(function() {
                s(T / 100)
            }, Q)
        })
    }
