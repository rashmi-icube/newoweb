...
$(document).ready(function () {
    ...
    if ($('#moduleName').val() === "dashboard") {
        var chartIdArray = ['container1', 'container2', 'container3'];
        jQuery.each(chartIdArray, function (i, chartId) {
            createGaugeChart(chartId);
        });
    }

    if ($('#moduleName').val() === "report") {
        var chartHeatmapId = 'heatmapContainer';
...
//Demo: for Legend Hover functionality - http://jsfiddle.net/highcharts/Ha3Wr/
    Highcharts.chart(chartId, {
        chart: {
            type: 'solidgauge',
            marginTop: 50
...
function createScatterPlot(chartId) {
    Highcharts.chart(chartId, {
        chart: {
            type: 'scatter',
            zoomType: 'xy'
