    ...
    <body>
        <div class="swiper-container">
            ...
            <div class="site-nav survey">
                <a class="site-nav-dash1" href="/mobileapp/thankyou.jsp" title="Go to Thank You" >&#x276F;</a>
            </div>
            <% } else if (len == 1) { %>
            <div class="site-nav survey">
                <a class="site-nav-dash1" href="/mobileapp/thankyou.jsp" title="Go to Thank You" >&#x276F;</a>
            ...
            <div class="site-nav survey">
                ...
                <a class="site-nav-dash" href="/mobileapp/thankyou.jsp" title="Go to Thank You" style="display:none;">&#x276F;</a>
            </div>
            <% }%>
