...
public interface Constant {
    ...
    public static final String[] TEAM_IMAGE = { "network-cluster-t1.png", "network-cluster-t2.png", "network-cluster-t3.png", "network-cluster-t4.png", "network-cluster-t5.png"};
